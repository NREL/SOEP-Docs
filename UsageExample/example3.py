...
main3.clone_repo_to(REPO_URL, OLD_BRANCH, OLD_BRANCH)
main3.clone_repo_to(REPO_URL, NEW_BRANCH, NEW_BRANCH)
main3.call_api_generator(OLD_BRANCH, OLD_API_FILE)
main3.call_api_generator(NEW_BRANCH, NEW_API_FILE)
main3.call_version_checker(OLD_API_FILE, NEW_API_FILE, DIFFS_FILE)
